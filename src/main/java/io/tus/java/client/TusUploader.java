...
public class TusUploader {
     ...
     */
    public TusUploader(TusClient client, String local_file_path, URL uploadURL, TusInputStream input, long file_total_size, long offset) throws IOException {
    ...
    public void setInput() {
    	try {
    		FileInputStream tmp = new FileInputStream(new File(local_file_path));
    		input = new TusInputStream(tmp);
    		input.seekTo(offset);
    	} catch(Exception e) {
    		e.printStackTrace();
    	}
    ...
    public void openConnection() throws IOException, ProtocolException {
...
//        }
    ...
    public void finish() throws ProtocolException, IOException {
        ...
        //上传完成的文件记录在本地的download_offset.properties配置文件中
    ...
    public void finishConnection() throws ProtocolException, IOException {
        ...
        if(connection != null) {
            ...
            // detect changes and seek accordingly
